                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <td><strong>Rp. {{ number_format($penjualan->total_harga, 0, ',', '.')
                                                }}</strong></td>
                                    </tr>
                                    <tr class="bg-light">
                                        <td colspan="2"></td>
                                        <td><strong>Total Bayar</strong></td>
                                        <td><strong>Rp. {{ number_format($penjualan->uang_diberi, 0, ',', '.')
                                                }}</strong></td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control"
                                value="{{ old('name', $existingMember->name ?? '') }}" {{ $existing ? 'readonly' : ''
                                }}>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @endphp
                            <input type="text" id="poin" value="{{ $poinSebelumnya }}" disabled class="form-control">
                        ...
                        <div class="mb-3 form-check">
                            <input class="form-check-input" type="checkbox" value="Ya" id="check_poin" name="check_poin"
                                {{ ($existing && $existingMember && !$existingMember->isFirstTransaction()) ? '' : 'disabled' }}>
                        
                            <label class="form-check-label" for="check_poin">
                                Gunakan poin untuk potongan harga
                            </label>
                        
                            @if(!$existing || !$existingMember || $existingMember->isFirstTransaction())
